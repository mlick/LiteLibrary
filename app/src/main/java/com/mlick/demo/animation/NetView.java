...
/**
 * Created by lxx on 2016/8/11 16:27
 */
...
public class NetView extends View {
     ...
     * 覆盖区透明度
     */
    private int mOverlayAlpha = 100;

    /**
     * 覆盖区圆圈颜色
     */
    private int mCircleColor = Color.parseColor("#e040fb");

    /**
     * 标签文本字体颜色
     */
    private int mTextColor = Color.parseColor("#304ffe");

    /**
     * 覆盖区颜色
     */
    private int mOverlayColor = Color.parseColor("#e040fb");

    /**
     * 网格线颜色
     */
    private int mNetColor = Color.parseColor("#2196f3");
    /**
     * 覆盖区圆圈半径
     */
...
//                .obtainStyledAttributes(attrs, R.styleable.netView, defStyleAttr, 0);
//
//        mNetColor = attributes.getColor(R.styleable.netView_netColor, ContextCompat
//                .getColor(context, R.color.defNetColor));
//        mOverlayColor = attributes.getColor(R.styleable.netView_overlayColor, ContextCompat
//                .getColor(context, R.color.defOverlayColor));
//        mTextColor = attributes.getColor(R.styleable.netView_textColor, ContextCompat
//                .getColor(context, R.color.defTextColor));
//        mCircleColor = attributes.getColor(R.styleable.netView_overlayCircleColor, ContextCompat
//                .getColor(context, R.color.defOverlayCircleColor));
//
...
//        mOverlayCircleRadius = attributes
//                .getInteger(R.styleable.netView_overlayCircleRadius, mOverlayCircleRadius);
//
//        // 回收数组
//        attributes.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mList.size() <= 0) {
            ...
            canvas.drawText(text, mCenterX - mTextPaint
                    .measureText(text) / 2, mCenterY, mTextPaint);
            return;
        }
