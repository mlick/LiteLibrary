...
/**
 * Created by lxx on 2016/8/11 16:42
 */
...
//                .obtainStyledAttributes(attrs, R.styleable.RadarView, defStyleAttr, 0);
//
...
//        imageView
//                .setLayoutParams(new ViewGroup.MarginLayoutParams((int) mBitmapWidth, (int) mBitmapWidth));
//        Glide.with(getContext()).load(resource).asBitmap().centerCrop()
...
//        imageView
//                .setLayoutParams(new ViewGroup.MarginLayoutParams((int) mBitmapWidth, (int) mBitmapWidth));
//        Glide.with(getContext()).load(url).asBitmap().centerCrop()
//             .transform(new RoundImageTransform(getContext()))
//             .into(new BitmapImageViewTarget(imageView) {
//                 @Override
//                 protected void setResource(Bitmap resource) {
