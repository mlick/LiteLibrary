...
public class MyReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Log.d(TAG, "[MyReceiver] onReceive - " + intent
                .getAction() + ", extras: " + printBundle(bundle));
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
            ...
            Log.d(TAG, "[MyReceiver] 接收到推送下来的自定义消息: " + bundle
...
//        	context.startActivity(i);
            ...
            boolean connected = intent
                    .getBooleanExtra(JPushInterface.EXTRA_CONNECTION_CHANGE, false);
            Log.w(TAG, "[MyReceiver]" + intent
                    .getAction() + " connected state change to " + connected);
        } else {
    ...
    public static void dealWithPushInfo(Context context) {
    ...
    private static String printBundle(Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            if (key.equals(JPushInterface.EXTRA_ALERT)) {
                Log.i(TAG, ">>>key " + key + bundle.getString(key));
